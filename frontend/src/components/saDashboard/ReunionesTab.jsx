						...
						>
							<div className="flex items-center justify-center gap-2">
								...
								{upcomingMeetings.length > 0 && (
									<span className={`px-2 py-0.5 rounded-full text-xs ${activeTab === 'upcoming'
						...
						>
							<div className="flex items-center justify-center gap-2">
								...
								{pastMeetings.length > 0 && (
									<span className={`px-2 py-0.5 rounded-full text-xs ${activeTab === 'past'
											? 'bg-blue-100 text-blue-700'
											: 'bg-gray-200 text-gray-600'
										}`}>
										{pastMeetings.length}
				...
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
					...
					<div className="flex flex-wrap gap-4 pt-6 border-t border-gray-200">
						<button
							...
							className={`flex items-center gap-2 bg-gradient-to-br from-[#27ae60] to-[#229954] text-white font-semibold px-6 py-3 rounded-lg hover:-translate-y-0.5 hover:shadow-lg transition-all ${createMeetingMutation.isPending
