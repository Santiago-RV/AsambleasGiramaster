...
const ZoomConfigModal = ({ isOpen, onClose, currentConfig, onSave, isSaving }) => {
    ...
    const tabs = [
        { id: 'sdk', label: 'Meeting SDK', icon: Smartphone },
        { id: 'oauth', label: 'Server-to-Server OAuth', icon: Server }
    ];
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="space-y-6">
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <p className="text-sm text-blue-700 flex items-start gap-2">
                                    ...
                                    <span><strong>Meeting SDK:</strong> Estas credenciales permiten a los usuarios unirse a reuniones desde el navegador web.</span>
                                </p>
                            </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                <p className="text-sm text-green-700 flex items-start gap-2">
                                    ...
                                    <span><strong>Server-to-Server OAuth:</strong> Estas credenciales permiten crear, modificar y eliminar reuniones mediante la API REST de Zoom.</span>
                                </p>
                            </div>
                            ...
                            <div>
                                <label className="block mb-2 font-semibold text-gray-700 flex items-center gap-2">
                                    Client Secret *
                                    <Tooltip text="Clave secreta OAuth. Debe mantenerse privada." />
                                </label>
                                <div className="relative">
                                    <input
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        <p className="text-sm text-yellow-800 flex items-start gap-2">
                            ...
                            <span><strong>Seguridad:</strong> Todas las credenciales sensibles se almacenan encriptadas en la base de datos.</span>
                        </p>
                    </div>
                </form>
            </div>
