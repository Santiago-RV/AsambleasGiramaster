        ...
        >
            ...
            <div className="flex flex-col items-center text-center space-y-6">
                ...
                <button
                    ...
                    disabled={isLoading}
                    className="w-full mt-4 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed group-hover:scale-105"
                >
                    {isConfigured ? (
                        <>
                            <Edit size={18} />
...
export default ZoomCredentialCard;
