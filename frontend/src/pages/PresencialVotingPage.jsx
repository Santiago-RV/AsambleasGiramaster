...
export default function PresencialVotingPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const pollsResponse =
                    await PollService.getPollsByMeeting(meetingId);
                ...
                try {
                    const delegationResponse =
                        await DelegationService.getUserDelegationStatus(
                            meetingId,
                        );
                    setDelegationStatus(
                        delegationResponse?.data ?? delegationResponse ?? null,
                    );
                } catch {
    ...
    const handleOptionToggle = (optionId) => {
        if (poll.str_poll_type === "single") {
            ...
            setSelectedOptions((prev) => {
                ...
                const maxSelections =
                    poll.int_max_selections || poll.options?.length || 999;
    ...
    const handleVote = async () => {
        if (poll.str_poll_type === "text") {
            ...
            setIsVoting(true);
            try {
                await PollService.vote(poll.id, {
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100 px-4">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-amber-300 p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                        Tu <strong>asistencia y votación</strong> en esta
                        reunión dependen de la presencia de{" "}
                        <span className="font-semibold text-gray-800">
                            {delegatedName}
                        </span>
                        .
                    ...
                    <p className="text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 mb-6">
                        Si tienes dudas o crees que esto es un error, por favor
                        contáctate con el administrador de tu unidad
                        residencial.
                    </p>
                    <div className="mb-3">
                        <div className="w-full bg-gray-200 rounded-full h-2">
                            <div
                                ...
                                style={{
                                    width: `${(delegationCountdown / 10) * 100}%`,
                                }}
                            />
                        </div>
                    </div>
                    <p className="text-sm text-gray-500">
                        ...
                        segundo{delegationCountdown !== 1 ? "s" : ""}...
                    </p>
                </div>
            </div>
        );
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-orange-100">
                <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-4 text-center">
                    ...
                    {meeting && (
                        <p className="text-gray-600 mb-4">
                            La reunión <strong>{meeting.str_title}</strong> no
                            tiene encuestas activas en este momento.
                        </p>
                    )}
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-red-100">
                <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-4 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        El tiempo de votación para{" "}
                        <strong>"{poll?.str_title}"</strong> ha terminado.
                    </p>
                    {countdown !== null && (
                        <div className="bg-gray-100 rounded-xl p-6">
                            <p className="text-gray-600 mb-2">
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100">
                <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-4 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        Tu voto para <strong>"{poll.str_title}"</strong> ha sido
            ...
            <div className="max-w-2xl mx-auto">
                            ...
                            <div className="bg-white rounded-xl shadow-md border-2 border-green-300 p-4 mb-6">
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-green-700">
                                            Tu voto contará con el peso
                                            acumulado de todos los poderes
                                            cedidos
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    {receivedDelegations.map((d, i) => (
                                        ...
                                        >
                                            <span className="text-sm font-medium text-gray-800">
                                                {d.delegator.str_firstname}{" "}
                                                {d.delegator.str_lastname}
                                            </span>
                                ...
                                <div className="flex items-center justify-between bg-green-100 rounded-lg px-3 py-2 border-2 border-green-300">
                                    <span className="text-sm font-semibold text-green-800">
                                        Peso total de votación:
                                    </span>
                                    <span className="text-xl font-bold text-green-700">
                                        {parseFloat(
                                            delegationStatus?.total_weight ?? 0,
                                        ).toFixed(4)}
                                        %
                                    </span>
                                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
                        ...
                        <div className="flex items-center gap-4 mt-3 text-sm text-blue-100">
                            <div className="flex items-center gap-1">
                                <Clock size={16} />
                                {formatDateTime(poll.dat_started_at)}
                            </div>
                        </div>
                        {poll.dat_ended_at &&
                            (() => {
                                ...
                                const totalMs =
                                    parseColombiaDate(poll.dat_ended_at) -
                                    parseColombiaDate(poll.dat_started_at);
                                const leftMs =
                                    rem.minutes * 60000 + rem.seconds * 1000;
                                const pct = Math.max(
                                    0,
                                    Math.min(100, (leftMs / totalMs) * 100),
                                );
                                ...
                                return (
                                    <div className="mt-4">
                                        <div className="flex items-center justify-between text-xs text-blue-100 mb-1">
                                            ...
                                            <span
                                                className={`font-mono font-bold text-lg ${isUrgent ? "text-red-300 animate-pulse" : "text-white"}`}
                                            >
                                                {timeStr}
                                            </span>
                                        </div>
                    ...
                    <div className="p-6">
                        ...
                        {poll.bln_is_anonymous && (
                            <div className="mb-4 flex items-center gap-2 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl">
                                ...
                                <p className="text-sm text-slate-600">
                                    ...
                                    tu identidad no será revelada al registrar
                                    tu respuesta.
                                </p>
                            </div>
                        )}
                        ...
                        {poll.str_poll_type === "numeric" && (
                            <div className="mb-6">
                                <input
                                    ...
                                    onChange={(e) =>
                                        setNumericResponse(e.target.value)
                                    }
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <span
                                                        className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${isSelected ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-600"}`}
                                                    >
                                                        {String.fromCharCode(
                                                            65 + index,
                                                        )}
                        ...
                        <div
                            className={`flex gap-3 ${poll.bln_allows_abstention ? "flex-col sm:flex-row" : ""}`}
                        >
                            <button
                                onClick={handleVote}
                                disabled={
                ...
                <button
                    ...
                    className="mt-6 w-full py-3 bg-white text-gray-600 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
                >
                    <LogOut size={18} />
                    Salir sin votar
                </button>
